...
export const createCommonServer = <T extends TableConfig = TableConfig>(
  table: PgTable<T>,
) => {
  const schema = {
...
export type CommonServer<T extends TableConfig = TableConfig> = ReturnType<
  typeof createCommonServer<T>
>;
